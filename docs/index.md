...
[简体中文](zh-CN/) · [GitHub repository](https://github.com/redtidev1918/release-infra)

## Start here

1. Read the [architecture](ARCHITECTURE.md) and [policy contract](POLICY.md).
2. Copy the [control repository example](https://github.com/redtidev1918/release-infra/tree/v1/examples/control).
